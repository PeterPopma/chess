...
namespace Chess
{
    public abstract class ParticleSystem 
    {
        ...
        protected ParticleSystem(SpriteBatch spriteBatch, int howManyEffects)
        {
        ...
        public void AddParticles(Vector2 where, Color color)
        {
            ...
            int numParticles =
                rand.Next(minNumParticles, maxNumParticles);
        ...
        protected virtual void InitializeParticle(Particle p, Vector2 where, Color color)
        {
            ...
            float velocity =
                rand.NextFloat(minInitialSpeed, maxInitialSpeed);
            float acceleration =
                rand.NextFloat(minAcceleration, maxAcceleration);
            float lifetime =
                rand.NextFloat(minLifetime, maxLifetime);
            float scale =
                rand.NextFloat(minScale, maxScale);
            float rotationSpeed =
                rand.NextFloat(minRotationSpeed, maxRotationSpeed);
